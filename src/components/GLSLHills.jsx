...
const GLSLHills = ({ 
  ...
  planeSize = 256, 
  speed = 0.5,
  colorRgb = [0.9, 0.0, 0.49] // Default RAK Magenta tint: rgb(230, 0, 126)
}) => {
  ...
  useEffect(() => {
    ...
    class Plane {
      constructor() {
        this.uniforms = {
          time: { type: 'f', value: 0 },
          uColor: { type: 'v3', value: new THREE.Vector3(...colorRgb) }
        };
          ...
          new THREE.RawShaderMaterial({
            ...
            fragmentShader: `
              ...
              void main(void) {
                ...
                gl_FragColor = vec4(uColor, max(0.0, opacity));
              }
            `,
            wireframe: true,
            transparent: true
  ...
  }, [cameraZ, planeSize, speed, colorRgb]);
