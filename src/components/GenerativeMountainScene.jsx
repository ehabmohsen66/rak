 ...
 * * Renders a solid, undulating landscape shader in the footer.
 * * Uses RAK Brand Magenta & Dark Theme Violet Palette with interactive specular light.
 */
export function GenerativeMountainScene() {
  ...
  useEffect(() => {
    ...
    const handleMouseMove = (e) => {
      ...
      const lightX = x * 6;
      const lightY = 2 + y * 2;
      const pos = new THREE.Vector3(lightX, lightY, 3);
